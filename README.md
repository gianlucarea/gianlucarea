...
I'm a **Software Engineer** with experience building and maintaining production-grade backend systems in enterprise and research environments. I focus on clean architecture, system reliability, and delivering scalable solutions.
...
* 💻 **Core Mastery**: Java, Spring Boot, Python, PostgreSQL, OracleDB, Redis, and Git.
* 🌱 **Professional Proficiency**: Go, Django, React, RabbitMQ, Docker, AWS, GitHub Actions, and Grafana.
* 🚀 **Strategic Interests**: Rust, Elixir, and Kubernetes.
* 📚 **Personal Interests**: I also like reading, indulging in history, and watching football!
